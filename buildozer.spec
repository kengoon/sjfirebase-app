...
# (str) Package name
package.name = firebaseapp

# (str) Package domain (needed for android/ios packaging)
package.domain = org.sjfirbase
...
requirements = python3,kivy==master,https://github.com/kivymd/KivyMD/archive/master.zip,sjfirebase,
    materialyoucolor,pillow,asynckivy,asyncgui
